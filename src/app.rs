...
use cosmwasm_std::{
    ...
    CustomQuery, Empty, Querier, QuerierResult, QuerierWrapper, QueryRequest, Record, StdResult,
    ...
    GovT: Gov,
{
    ...
    pub fn get_querier_storage(&self) -> StdResult<QuerierStorage> {
...
pub trait CosmosRouter {
    ...
    fn get_querier_storage(&self, storage: &dyn Storage) -> StdResult<QuerierStorage>;
}
    ...
    QueryC: CustomQuery,
{
    ...
    fn get_querier_storage(&self, _storage: &dyn Storage) -> StdResult<QuerierStorage> {
