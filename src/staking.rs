...
use cosmwasm_std::{
    ...
    StakingQuery, StdResult, Storage, Timestamp, Uint128, Uint256, Validator, ValidatorResponse,
};
...
impl StakeKeeper {
    ...
    fn get_rewards_internal(
        ...
        Ok(Coin {
            ...
            amount: Uint128::new(1).mul_floor(delegator_rewards).into(), // multiplying by 1 to convert Decimal to Uint128
        })
    }
    ...
    fn get_stake(
        ...
        Ok(shares.map(|shares| {
            Coin {
                denom: staking_info.bonded_denom,
                amount: Uint128::new(1).mul_floor(shares.stake).into(), // multiplying by 1 to convert Decimal to Uint128
            }
        }))
    }
    ...
    fn add_stake(
        ...
        self.update_stake(
            ...
            to_address,
            validator,
            amount.amount.to_string().parse::<u128>()?,
            false,
        )
    }
                    ...
                    let delegation = self
                        ...
                        .map(|mut stake| {
                            ...
                            stake.amount += unbonding_queue
                                ...
                                .map(|u| Uint256::new(u.amount.u128()))
                                .sum::<Uint256>();
                            stake
                        });
                    match delegation {
        ...
        match msg {
            ...
            StakingMsg::Undelegate { validator, amount } => {
                ...
                unbonding_queue.push_back(Unbonding {
                    ...
                    validator,
                    amount: amount.amount.to_string().parse::<u128>()?.into(),
