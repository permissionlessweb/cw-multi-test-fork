...
use cosmwasm_std::{
    ...
    Event, Order, Querier, Storage, Uint256,
};
use cosmwasm_std::{StdResult, SupplyResponse};
...
impl BankKeeper {
    ...
    fn get_balance(&self, bank_storage: &dyn Storage, account: &Addr) -> StdResult<Vec<Coin>> {
...
impl Module for BankKeeper {
    ...
    fn execute<ExecC, QueryC>(
        ...
        match msg {
            ...
            m => std_error_bail!("Unsupported bank message: {:?}", m),
        }
    }
    ...
    fn query(
        ...
        match request {
            ...
            q => std_error_bail!("Unsupported bank query: {:?}", q),
        }
    }
}
